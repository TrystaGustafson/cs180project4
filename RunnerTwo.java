                ...
                if (rol.equals("1")) {
                    ...
                    if (category.toUpperCase().equals("STUDENT")) {
                        ...
                        if (alreadyRegistered) {
                            System.out.println("You are already a registered user, so you have been directly logged in.");
            ...
            if (category.toUpperCase().equals("TEACHER")) {
                ...
                do {
                    ...
                    switch (teacherChoice) {
                        ...
                        case "2": {
                            BufferedReader m = new BufferedReader(new FileReader
                                    (name + "$$" + userName + "$$" + password + "$$Courses.txt"));
                            String r = m.readLine();
                            while (r != null) {
                                ...
                                do {
                                    ...
                                    switch (choiceAgain) {
                                        case "1": {
                                            ...
                                            do {
                                                System.out.println("Do you want to attach a file or add it manually?");
                                            ...
                                            do {
                                                System.out.println("Do you want to randomize this quiz?");
                                            ...
                                            try {
                                                ...
                                                tyu = t.getListCourses().get(t.getListCourses().size() - 1).createQuiz
                                                        (quizNumber, quizListFileName, numOfQuestions, type, poolOrExact, fileOrManually, randomize);
                                            } catch (FileNotFoundException e) {
                                                e.printStackTrace();
                                            } catch (IOException e) {
                                                e.printStackTrace();
                                            ...
                                            if (tyu) {
                                                if (choice90.equals("1") && choice89.equals("1")) {
                                                    ...
                                                    do {
                                                        ...
                                                        d = t.getListCourses().get(n - 1).getListQuizzes().get(size - 1).makePoolQuizFile
                                                                (filePath, quizFileName, answerFilePath);
                                                        if (d) {
                                                    ...
                                                    do {
                                                        ...
                                                        int size = t.getListCourses().get(n - 1).getListQuizzes().size();
                                                        String quizFileName = name + "$$" + courseName + "$$" + Integer.toString(quizNumber) + ".txt";
                                                        d = t.getListCourses().get(n - 1).getListQuizzes().get(size - 1).makeExactQuizFile
                                                                (filePath, quizFileName, answerFilePath);
                                                        if (d) {
                                                            System.out.println("The quiz was made successfully");
                                                        } else {
                                                ...
                                                System.out.println("This quiz has already been created.");
                                            }
                                            jkl = false;
                                            break;
                                        }
                                        case "2": {
                                            String quizListFileName = name + "$$" + courseName + "$$quizList.txt";
                                            BufferedReader mr = new BufferedReader(new FileReader
                                                    (name + "$$" + courseName + "$$quizList.txt"));
                                            ...
                                            if (t.getListCourses().get(t.getListCourses().size() - 1).enterQuiz
                                                    (quizNumber, quizListFileName).equals("filepool")) {
                                                boolean d;
                                                do {
                                                    System.out.println("Enter the file path of the quiz:");
                                                    String filePath = sc.nextLine();
                                            ...
                                            } else if (t.getListCourses().get(t.getListCourses().size() - 1).enterQuiz
                                                    (quizNumber, quizListFileName).equals("fileexact")) {
                                                boolean d;
                                                do {
                                                    System.out.println("Enter the file path of the quiz:");
                                                    String filePath = sc.nextLine();
                                                    ...
                                                    (quizNumber, quizListFileName).contains("manualpool")) {
                                                if (t.getListCourses().get(t.getListCourses().size() - 1).enterQuiz
                                                        (quizNumber, quizListFileName).contains("MCQ")) {
                                                    String quizFileName = name + "$$" + courseName + "$$" + Integer.toString(quizNumber) + ".txt";
                                                    int n = t.getListCourses().size();
                                                    int size = t.getListCourses().get(n - 1).getListQuizzes().size();
                                                    t.getListCourses().get(n - 1).getListQuizzes().get(size - 1).makeQuizManual(quizFileName, "MCQ");
                                                } else if (t.getListCourses().get(t.getListCourses().size() - 1).enterQuiz
                                                        (quizNumber, quizListFileName).contains("fillintheblanks")) {
                                                    String quizFileName = name + "$$" + courseName + "$$" + Integer.toString(quizNumber) + ".txt";
                                                    int n = t.getListCourses().size();
                                                    int size = t.getListCourses().get(n - 1).getListQuizzes().size();
                                                    t.getListCourses().get(n - 1).getListQuizzes().get(size - 1).makeQuizManual
                                                            (quizFileName, "fill in the blanks");
                                                } else {
                                                    String quizFileName = name + "$$" + courseName + "$$" + Integer.toString(quizNumber) + ".txt";
                                                    int n = t.getListCourses().size();
                                                    int size = t.getListCourses().get(n - 1).getListQuizzes().size();
                                                    ...
                                                    (quizNumber, quizListFileName).contains("manualexact")) {
                                                if (t.getListCourses().get(t.getListCourses().size() - 1).enterQuiz
                                                        (quizNumber, quizListFileName).contains("MCQ")) {
                                                    String quizFileName = name + "$$" + courseName + "$$" + Integer.toString(quizNumber) + ".txt";
                                                    int n = t.getListCourses().size();
                                        ...
                                        case "3": {
                                            ...
                                            if (choice1.equals("1")) {
                                                File ert = new File(studentName + "$$" + name + "$$" + courseName + "$$"
                                                        + Integer.toString(quizNumber) + "$$" + Integer.toString(attemptNumber) + "$$gradingReport.txt");
                                                if (ert.exists()) {
                                                ...
                                                File ert = new File(studentName + "$$" + name + "$$" + courseName + "$$"
                                                        + Integer.toString(quizNumber) + "$$" + Integer.toString(attemptNumber) + "$$submission.txt");
                                                if (ert.exists()) {
                                                    BufferedReader bf = new BufferedReader(new FileReader(ert));
                                                    String printings = bf.readLine();
                                                    while (printings != null) {
                                        ...
                                        case "4": {
                                            BufferedReader bfu = new BufferedReader(new FileReader(name + "$$" + courseName + "$$quizList.txt"));
                        ...
                        case "3": {
                            BufferedReader m = new BufferedReader(new FileReader(name + "$$"
                            ...
                            if (c > 0) {
                                ...
                                System.out.println("Course does not already exist.");
                            }
                            a = false;
                            break;
                        }
                ...
                do {
                    ...
                    if (!(contents == null || contents.equals(""))) {
                        ...
                        attemptNumber--;
                        File sft = new File(name + "$$" + teacherName + "$$" + courseName + "$$"
                                + Integer.toString(quizNumber) + "$$" + Integer.toString(attemptNumber + 1) + "$$submission.txt");
                        sft.createNewFile();
                        File studentAnswersOnly = new File(name + "$$" + teacherName + "$$" + courseName + "$$" +
                                Integer.toString(quizNumber) + "$$" + Integer.toString(attemptNumber + 1) + "$$submittedAnswers.txt");
                        ...
                        File f457 = new File(name + "$$" + teacherName + "$$" + courseName + "$$" + Integer.toString(quizNumber)
                                        ...
                                        while (readings != null) {
                                            ...
                                            if (cf == 1) {
                                                appendingString += String.format("%s@%s@qn-%d@attemptno-%d@qtsf-%d",
                                                        teacherName, courseName, quizNumber, attemptNumber + 1, counterAgain) + "\n";
                                            } else {
                                                appendingString += readings + "\n";
                                            }
                                            readings = bread.readLine();
                        ...
                        System.out.println("The quiz is over and is now being submitted.");
                        File quizGradingReport = new File(name + "$$" + teacherName + "$$"
                        ...
                        File f468 = new File(name + "$$" + teacherName + "$$" + courseName
                            ...
                            case "1": {
                                ...
                                if (findTeacher == null) {
                                    ...
                                    if (c == 0) {
                                        ...
                                        if (!f56.exists()) {
                                            System.out.println("This course does not exist for this teacher.");
                                        } else {
                                            boolean ki;
                                            do {
                                                ...
                                                switch (choice57) {
                                                    case "1": {
                                                        BufferedReader gyt = new BufferedReader(new FileReader(teacherName + "$$"
                                                        ...
                                                        if (c == 0) {
                                                            ...
                                                            BufferedReader br739 = new BufferedReader((new FileReader(teacherName
                                                                    + "$$" + courseName + "$$" + choice90 + ".txt")));
                                                            String copier = br739.readLine();
                                                            int noOfQuestionsRequired = Integer.parseInt(quizIdentifier.substring(quizIdentifier.indexOf('(') + 1,
                                                            ...
                                                            if (c34 % 5 == 0) {
                                                                if (quizIdentifier.contains("pool")) {
                                                                    if ((c34 / 5) >= 5) {
                                                                        ...
                                                                        quizIdentifier = quizIdentifier.substring(0, quizIdentifier.indexOf('(') + 1) +
                                                                                Integer.toString(c34 / 5) + s;
                                                                        Student student = new Student();
                                                                        student.takeQuiz(name, teacherName, courseName, choice90, quizIdentifier);
                                                                    } else {
                                                                        System.out.println("The quiz has not been completed by the teacher.");
                                                                    }
                                                    ...
                                                    case "2": {
                                                        ...
                                                        File ert = new File(name + "$$" + teacherName + "$$" + courseName + "$$" +
                                                                Integer.toString(quizNumber) + "$$" + Integer.toString(attemptNumber) + "$$submission.txt");
                                                        if (ert.exists()) {
                                                            BufferedReader bf = new BufferedReader(new FileReader(ert));
                                                            String printings = bf.readLine();
                                                            ...
                                                            System.out.println("This attempt for this quiz has not been completed yet or the " +
                                                    ...
                                                    case "3": {
                                                        ...
                                                        if (ert.exists()) {
                                                            ...
                                                            System.out.println("This attempt for this quiz has not been completed " +
                                                                    "yet or the quiz has not been attempted.");
                                                        }
                                                        ki = false;
                                                        break;
                                                    }
